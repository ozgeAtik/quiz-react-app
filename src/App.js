...
function App(props) {
  ...
  React.useEffect(() => {
    fetch(`https://opentdb.com/api.php?amount=5&category=${selectCategory}&type=multiple&encode=url3986`)
    .then(res => res.json())
  ...
  function startClick(val){
    ...
    switch(val){
      case "knowledge":
        ...
        break;
      case "film":
        setSelectCategory(11)
        break;
      case "music":
        setSelectCategory(12)
        break;
      case "television":
        setSelectCategory(14)
        break;
      case "games":
        setSelectCategory(15)
        break;
      case "nature":
        setSelectCategory(17)
        break;
      case "sports":
        setSelectCategory(21)
        break;
      case "history":
        setSelectCategory(23)
        break;
      case "art":
        setSelectCategory(25)
        break;
      case "celebs":
        setSelectCategory(26)
        break;
      case "animals":
        setSelectCategory(27)
        break;
      default:
        setSelectCategory(9)
    }
                  ...
                  <div className="first-page">
                    ...
                    <form action="#">
                      ...
                      <input className="start-button" type="button" value="Start Quiz" 
                            onClick={() => startClick(document.getElementById("category").value)}/>
                    </form>
                  </div>
                </div>}
    </>
